...
=== Version 1.2.1 - 2023-10-23

Release 1.2.1 provides:
...
. After installing the 1.2.0 demo in Anypoint Studio, deploy the application directly to CloudHub by selecting the 1.2.0 demo in the Project Explorer.  Then, right-click, and select "Anypoint Platform&rarr;Deploy to CloudHub".
...
. From Anypoint Studio, export a JAR of the demo 1.2.0 application by right-clicking the application name in Project Explorer, and selecting "Export".
...
image::marklogic-demo-1.2.0.png[Demo Flow]
...
image::exportDocs-config-demo-1.2.0.png[exportDocs Configuration]
...
image::import-demo-fs-2-1.2.0.png[Import Mule Project]
